...
void CDasherModel::AbortOffset() {
  ...
  //I assume that aborting the offset means resetting it
  m_iDisplayOffset = 0;
  //big section removed that calculated a lot of things and then returned them, but this is a void function
}
