...
namespace Dasher{
  namespace Settings {
	...
	const std::unordered_map<Parameter, const Parameter_Value> parameter_defaults = {
		...
		{LP_HOLD_TIME             , Parameter_Value{ "HoldTime"                  , PARAM_LONG, Persistence::PERSISTENT, 1000l , "Time for which buttons must be held to count as long presses, in ms", "", Settings::UIControlType::Step, 10, 10000, 1000, 10}},
